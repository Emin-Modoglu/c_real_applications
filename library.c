...
/* Programı daha iyi anlamak için standart gerçek hayatta'ki bir kütüphanede neler yapılabilir diye kendiniz ilk önce belirleyin sonra ise
  yapacağınız işlemleri yapacak fonksiyonları belirleyiniz ister tek dosyada ,ister farklı dosyalara kaydediniz...*/

char catagories[][15]={"Computer","Electronics","Electrical","Civil","Mechnnical","Architecture"};
void returnfunc(void);
void mainmenu(void);
void addbooks(void);
void deletebooks(void);                       //Burası fonksiyonları, main fonksiyonundan önce tanımlıyoruz çünkü c derleyici baştan sonra derledikten sonra koşturur..
void editbooks(void);
...
char ch,pass[20],password[20]="emin_modoglu";
int i=0,j;
